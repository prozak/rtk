...
quoteJavaExp dummy func s = do
  ...
  ast <- case scanTokens (dummy ++ " " ++ s1 ++ " " ++ dummy) >>= parseJava of
           ...
           Right a -> return a
  let expr = func ast
  dataToExpQ (const Nothing `Generics.extQ` antiJavaExp `Generics.extQ` antiOptDocCommentExp `Generics.extQ` antiTypeDeclarationExp `Generics.extQ` antiRule_2Exp `Generics.extQ` antiCompilationUnitExp `Generics.extQ` antiPackageExp `Generics.extQ` antiImportStatementExp `Generics.extQ` antiDocCommentExp `Generics.extQ` antiAnnotationExp `Generics.extQ` antiAnnotationArgumentsExp `Generics.extQ` antiAnnotationElementExp `Generics.extQ` antiRule_16Exp `Generics.extQ` antiExtendsListExp `Generics.extQ` antiImplementsListExp `Generics.extQ` antiFieldDeclarationExp `Generics.extQ` antiClassDeclarationExp `Generics.extQ` antiInterfaceDeclarationExp `Generics.extQ` antiAnnotationDeclarationExp `Generics.extQ` antiAnnotationTypeElementExp `Generics.extQ` antiEnumConstantExp `Generics.extQ` antiEnumConstantListExp `Generics.extQ` antiEnumDeclarationExp `Generics.extQ` antiNestedTypeDeclarationExp `Generics.extQ` antiRule_40Exp `Generics.extQ` antiRule_42Exp `Generics.extQ` antiMemberDeclarationExp `Generics.extQ` antiPrimitiveTypeKeywordExp `Generics.extQ` antiMemberAfterFirstIdExp `Generics.extQ` antiMoreTypeSpecifierExp `Generics.extQ` antiMemberRestExp `Generics.extQ` antiRule_49Exp `Generics.extQ` antiStatementBlockExp `Generics.extQ` antiVariableDeclaratorListExp `Generics.extQ` antiVariableDeclarationExp `Generics.extQ` antiOptVariableInitializerExp `Generics.extQ` antiVariableDeclaratorExp `Generics.extQ` antiVariableInitializerListExp `Generics.extQ` antiVariableInitializerExp `Generics.extQ` antiStaticInitializerExp `Generics.extQ` antiParameterListExp `Generics.extQ` antiParameterExp `Generics.extQ` antiStatementExp `Generics.extQ` antiOptExpressionExp `Generics.extQ` antiOptIdExp `Generics.extQ` antiStatementWithoutIfExp `Generics.extQ` antiOptElsePartExp `Generics.extQ` antiIfStatementExp `Generics.extQ` antiDoStatementExp `Generics.extQ` antiWhileStatementExp `Generics.extQ` antiForStatementExp `Generics.extQ` antiRule_65Exp `Generics.extQ` antiOptFinallyExp `Generics.extQ` antiTryStatementExp `Generics.extQ` antiRule_68Exp `Generics.extQ` antiSwitchStatementExp `Generics.extQ` antiExpressionExp `Generics.extQ` antiAssignmentOpExp `Generics.extQ` antiEqualityOpExp `Generics.extQ` antiRelationalOpExp `Generics.extQ` antiShiftOpExp `Generics.extQ` antiAdditiveOpExp `Generics.extQ` antiMultiplicativeOpExp `Generics.extQ` antiPrefixOpExp `Generics.extQ` antiPostfixOpExp `Generics.extQ` antiCreationExpressionExp `Generics.extQ` antiRule_81Exp `Generics.extQ` antiLiteralExp `Generics.extQ` antiArglistExp `Generics.extQ` antiTypeArgumentsExp `Generics.extQ` antiNonEmptyTypeArgumentsExp `Generics.extQ` antiTypeArgumentExp `Generics.extQ` antiWildcardTypeExp `Generics.extQ` antiTypeParametersExp `Generics.extQ` antiTypeParameterExp `Generics.extQ` antiTypeExp `Generics.extQ` antiTypeSpecifierExp `Generics.extQ` antiModifierExp `Generics.extQ` antiCompoundNameExp) expr
...
antiRule_81Exp :: [ Rule_81 ] -> Maybe (TH.Q TH.Exp)
antiRule_81Exp ((Anti_Rule_81 v):rest) =
 let restExp =   dataToExpQ (const Nothing `Generics.extQ` antiJavaExp `Generics.extQ` antiOptDocCommentExp `Generics.extQ` antiTypeDeclarationExp `Generics.extQ` antiRule_2Exp `Generics.extQ` antiCompilationUnitExp `Generics.extQ` antiPackageExp `Generics.extQ` antiImportStatementExp `Generics.extQ` antiDocCommentExp `Generics.extQ` antiAnnotationExp `Generics.extQ` antiAnnotationArgumentsExp `Generics.extQ` antiAnnotationElementExp `Generics.extQ` antiRule_16Exp `Generics.extQ` antiExtendsListExp `Generics.extQ` antiImplementsListExp `Generics.extQ` antiFieldDeclarationExp `Generics.extQ` antiClassDeclarationExp `Generics.extQ` antiInterfaceDeclarationExp `Generics.extQ` antiAnnotationDeclarationExp `Generics.extQ` antiAnnotationTypeElementExp `Generics.extQ` antiEnumConstantExp `Generics.extQ` antiEnumConstantListExp `Generics.extQ` antiEnumDeclarationExp `Generics.extQ` antiNestedTypeDeclarationExp `Generics.extQ` antiRule_40Exp `Generics.extQ` antiRule_42Exp `Generics.extQ` antiMemberDeclarationExp `Generics.extQ` antiPrimitiveTypeKeywordExp `Generics.extQ` antiMemberAfterFirstIdExp `Generics.extQ` antiMoreTypeSpecifierExp `Generics.extQ` antiMemberRestExp `Generics.extQ` antiRule_49Exp `Generics.extQ` antiStatementBlockExp `Generics.extQ` antiVariableDeclaratorListExp `Generics.extQ` antiVariableDeclarationExp `Generics.extQ` antiOptVariableInitializerExp `Generics.extQ` antiVariableDeclaratorExp `Generics.extQ` antiVariableInitializerListExp `Generics.extQ` antiVariableInitializerExp `Generics.extQ` antiStaticInitializerExp `Generics.extQ` antiParameterListExp `Generics.extQ` antiParameterExp `Generics.extQ` antiStatementExp `Generics.extQ` antiOptExpressionExp `Generics.extQ` antiOptIdExp `Generics.extQ` antiStatementWithoutIfExp `Generics.extQ` antiOptElsePartExp `Generics.extQ` antiIfStatementExp `Generics.extQ` antiDoStatementExp `Generics.extQ` antiWhileStatementExp `Generics.extQ` antiForStatementExp `Generics.extQ` antiRule_65Exp `Generics.extQ` antiOptFinallyExp `Generics.extQ` antiTryStatementExp `Generics.extQ` antiRule_68Exp `Generics.extQ` antiSwitchStatementExp `Generics.extQ` antiExpressionExp `Generics.extQ` antiAssignmentOpExp `Generics.extQ` antiEqualityOpExp `Generics.extQ` antiRelationalOpExp `Generics.extQ` antiShiftOpExp `Generics.extQ` antiAdditiveOpExp `Generics.extQ` antiMultiplicativeOpExp `Generics.extQ` antiPrefixOpExp `Generics.extQ` antiPostfixOpExp `Generics.extQ` antiCreationExpressionExp `Generics.extQ` antiRule_81Exp `Generics.extQ` antiLiteralExp `Generics.extQ` antiArglistExp `Generics.extQ` antiTypeArgumentsExp `Generics.extQ` antiNonEmptyTypeArgumentsExp `Generics.extQ` antiTypeArgumentExp `Generics.extQ` antiWildcardTypeExp `Generics.extQ` antiTypeParametersExp `Generics.extQ` antiTypeParameterExp `Generics.extQ` antiTypeExp `Generics.extQ` antiTypeSpecifierExp `Generics.extQ` antiModifierExp `Generics.extQ` antiCompoundNameExp) rest
     lvar = TH.varE $ TH.mkName v
   in Just [| $lvar ++ $restExp |]
antiRule_81Exp _ = Nothing
...
antiRule_16Exp :: [ Rule_16 ] -> Maybe (TH.Q TH.Exp)
antiRule_16Exp ((Anti_Rule_16 v):rest) =
 let restExp =   dataToExpQ (const Nothing `Generics.extQ` antiJavaExp `Generics.extQ` antiOptDocCommentExp `Generics.extQ` antiTypeDeclarationExp `Generics.extQ` antiRule_2Exp `Generics.extQ` antiCompilationUnitExp `Generics.extQ` antiPackageExp `Generics.extQ` antiImportStatementExp `Generics.extQ` antiDocCommentExp `Generics.extQ` antiAnnotationExp `Generics.extQ` antiAnnotationArgumentsExp `Generics.extQ` antiAnnotationElementExp `Generics.extQ` antiRule_16Exp `Generics.extQ` antiExtendsListExp `Generics.extQ` antiImplementsListExp `Generics.extQ` antiFieldDeclarationExp `Generics.extQ` antiClassDeclarationExp `Generics.extQ` antiInterfaceDeclarationExp `Generics.extQ` antiAnnotationDeclarationExp `Generics.extQ` antiAnnotationTypeElementExp `Generics.extQ` antiEnumConstantExp `Generics.extQ` antiEnumConstantListExp `Generics.extQ` antiEnumDeclarationExp `Generics.extQ` antiNestedTypeDeclarationExp `Generics.extQ` antiRule_40Exp `Generics.extQ` antiRule_42Exp `Generics.extQ` antiMemberDeclarationExp `Generics.extQ` antiPrimitiveTypeKeywordExp `Generics.extQ` antiMemberAfterFirstIdExp `Generics.extQ` antiMoreTypeSpecifierExp `Generics.extQ` antiMemberRestExp `Generics.extQ` antiRule_49Exp `Generics.extQ` antiStatementBlockExp `Generics.extQ` antiVariableDeclaratorListExp `Generics.extQ` antiVariableDeclarationExp `Generics.extQ` antiOptVariableInitializerExp `Generics.extQ` antiVariableDeclaratorExp `Generics.extQ` antiVariableInitializerListExp `Generics.extQ` antiVariableInitializerExp `Generics.extQ` antiStaticInitializerExp `Generics.extQ` antiParameterListExp `Generics.extQ` antiParameterExp `Generics.extQ` antiStatementExp `Generics.extQ` antiOptExpressionExp `Generics.extQ` antiOptIdExp `Generics.extQ` antiStatementWithoutIfExp `Generics.extQ` antiOptElsePartExp `Generics.extQ` antiIfStatementExp `Generics.extQ` antiDoStatementExp `Generics.extQ` antiWhileStatementExp `Generics.extQ` antiForStatementExp `Generics.extQ` antiRule_65Exp `Generics.extQ` antiOptFinallyExp `Generics.extQ` antiTryStatementExp `Generics.extQ` antiRule_68Exp `Generics.extQ` antiSwitchStatementExp `Generics.extQ` antiExpressionExp `Generics.extQ` antiAssignmentOpExp `Generics.extQ` antiEqualityOpExp `Generics.extQ` antiRelationalOpExp `Generics.extQ` antiShiftOpExp `Generics.extQ` antiAdditiveOpExp `Generics.extQ` antiMultiplicativeOpExp `Generics.extQ` antiPrefixOpExp `Generics.extQ` antiPostfixOpExp `Generics.extQ` antiCreationExpressionExp `Generics.extQ` antiRule_81Exp `Generics.extQ` antiLiteralExp `Generics.extQ` antiArglistExp `Generics.extQ` antiTypeArgumentsExp `Generics.extQ` antiNonEmptyTypeArgumentsExp `Generics.extQ` antiTypeArgumentExp `Generics.extQ` antiWildcardTypeExp `Generics.extQ` antiTypeParametersExp `Generics.extQ` antiTypeParameterExp `Generics.extQ` antiTypeExp `Generics.extQ` antiTypeSpecifierExp `Generics.extQ` antiModifierExp `Generics.extQ` antiCompoundNameExp) rest
     lvar = TH.varE $ TH.mkName v
   in Just [| $lvar ++ $restExp |]
antiRule_16Exp _ = Nothing
...
antiRule_81Pat :: [ Rule_81 ] -> Maybe (TH.Q TH.Pat)
antiRule_81Pat [Anti_Rule_81 v] = Just $ TH.varP (TH.mkName v)
antiRule_81Pat _ = Nothing
...
antiRule_16Pat :: [ Rule_16 ] -> Maybe (TH.Q TH.Pat)
antiRule_16Pat [Anti_Rule_16 v] = Just $ TH.varP (TH.mkName v)
antiRule_16Pat _ = Nothing
...
creationExpression = QuasiQuoter (quoteJavaExp "tok_CreationExpression_dummy_163" getCreationExpression ) (quoteJavaPat "tok_CreationExpression_dummy_163" getCreationExpression ) quoteJavaType quoteJavaDecs

getDimExprs ( Ctr__Java__16 _ s) = s

dimExprs :: QuasiQuoter
dimExprs = QuasiQuoter (quoteJavaExp "tok_DimExprs_dummy_162" getDimExprs ) (quoteJavaPat "tok_DimExprs_dummy_162" getDimExprs ) quoteJavaType quoteJavaDecs

getDims ( Ctr__Java__17 _ s) = s

dims :: QuasiQuoter
dims = QuasiQuoter (quoteJavaExp "tok_Dims_dummy_161" getDims ) (quoteJavaPat "tok_Dims_dummy_161" getDims ) quoteJavaType quoteJavaDecs

getDoStatement ( Ctr__Java__18 _ s) = s

doStatement :: QuasiQuoter
doStatement = QuasiQuoter (quoteJavaExp "tok_DoStatement_dummy_160" getDoStatement ) (quoteJavaPat "tok_DoStatement_dummy_160" getDoStatement ) quoteJavaType quoteJavaDecs

getDocComment ( Ctr__Java__19 _ s) = s

docComment :: QuasiQuoter
docComment = QuasiQuoter (quoteJavaExp "tok_DocComment_dummy_159" getDocComment ) (quoteJavaPat "tok_DocComment_dummy_159" getDocComment ) quoteJavaType quoteJavaDecs

getEnumConstant ( Ctr__Java__20 _ s) = s

enumConstant :: QuasiQuoter
enumConstant = QuasiQuoter (quoteJavaExp "tok_EnumConstant_dummy_158" getEnumConstant ) (quoteJavaPat "tok_EnumConstant_dummy_158" getEnumConstant ) quoteJavaType quoteJavaDecs

getEnumConstantList ( Ctr__Java__21 _ s) = s

enumConstantList :: QuasiQuoter
enumConstantList = QuasiQuoter (quoteJavaExp "tok_EnumConstantList_dummy_157" getEnumConstantList ) (quoteJavaPat "tok_EnumConstantList_dummy_157" getEnumConstantList ) quoteJavaType quoteJavaDecs

getEnumDeclaration ( Ctr__Java__22 _ s) = s

enumDeclaration :: QuasiQuoter
enumDeclaration = QuasiQuoter (quoteJavaExp "tok_EnumDeclaration_dummy_156" getEnumDeclaration ) (quoteJavaPat "tok_EnumDeclaration_dummy_156" getEnumDeclaration ) quoteJavaType quoteJavaDecs

getEqualityOp ( Ctr__Java__23 _ s) = s

equalityOp :: QuasiQuoter
equalityOp = QuasiQuoter (quoteJavaExp "tok_EqualityOp_dummy_155" getEqualityOp ) (quoteJavaPat "tok_EqualityOp_dummy_155" getEqualityOp ) quoteJavaType quoteJavaDecs

getExpression ( Ctr__Java__24 _ s) = s

expression :: QuasiQuoter
expression = QuasiQuoter (quoteJavaExp "tok_Expression_dummy_154" getExpression ) (quoteJavaPat "tok_Expression_dummy_154" getExpression ) quoteJavaType quoteJavaDecs

getExtendsList ( Ctr__Java__25 _ s) = s

extendsList :: QuasiQuoter
extendsList = QuasiQuoter (quoteJavaExp "tok_ExtendsList_dummy_153" getExtendsList ) (quoteJavaPat "tok_ExtendsList_dummy_153" getExtendsList ) quoteJavaType quoteJavaDecs

getFieldDeclaration ( Ctr__Java__26 _ s) = s

fieldDeclaration :: QuasiQuoter
fieldDeclaration = QuasiQuoter (quoteJavaExp "tok_FieldDeclaration_dummy_152" getFieldDeclaration ) (quoteJavaPat "tok_FieldDeclaration_dummy_152" getFieldDeclaration ) quoteJavaType quoteJavaDecs

getFieldDeclarationList ( Ctr__Java__27 _ s) = s

fieldDeclarationList :: QuasiQuoter
fieldDeclarationList = QuasiQuoter (quoteJavaExp "tok_FieldDeclarationList_dummy_151" getFieldDeclarationList ) (quoteJavaPat "tok_FieldDeclarationList_dummy_151" getFieldDeclarationList ) quoteJavaType quoteJavaDecs

getForStatement ( Ctr__Java__28 _ s) = s

forStatement :: QuasiQuoter
forStatement = QuasiQuoter (quoteJavaExp "tok_ForStatement_dummy_150" getForStatement ) (quoteJavaPat "tok_ForStatement_dummy_150" getForStatement ) quoteJavaType quoteJavaDecs

getIfStatement ( Ctr__Java__29 _ s) = s

ifStatement :: QuasiQuoter
ifStatement = QuasiQuoter (quoteJavaExp "tok_IfStatement_dummy_149" getIfStatement ) (quoteJavaPat "tok_IfStatement_dummy_149" getIfStatement ) quoteJavaType quoteJavaDecs

getImplementsList ( Ctr__Java__30 _ s) = s

implementsList :: QuasiQuoter
implementsList = QuasiQuoter (quoteJavaExp "tok_ImplementsList_dummy_148" getImplementsList ) (quoteJavaPat "tok_ImplementsList_dummy_148" getImplementsList ) quoteJavaType quoteJavaDecs

getImportList ( Ctr__Java__31 _ s) = s

importList :: QuasiQuoter
importList = QuasiQuoter (quoteJavaExp "tok_ImportList_dummy_147" getImportList ) (quoteJavaPat "tok_ImportList_dummy_147" getImportList ) quoteJavaType quoteJavaDecs

getImportStatement ( Ctr__Java__32 _ s) = s

importStatement :: QuasiQuoter
importStatement = QuasiQuoter (quoteJavaExp "tok_ImportStatement_dummy_146" getImportStatement ) (quoteJavaPat "tok_ImportStatement_dummy_146" getImportStatement ) quoteJavaType quoteJavaDecs

getInterfaceDeclaration ( Ctr__Java__33 _ s) = s

interfaceDeclaration :: QuasiQuoter
interfaceDeclaration = QuasiQuoter (quoteJavaExp "tok_InterfaceDeclaration_dummy_145" getInterfaceDeclaration ) (quoteJavaPat "tok_InterfaceDeclaration_dummy_145" getInterfaceDeclaration ) quoteJavaType quoteJavaDecs

getLiteral ( Ctr__Java__34 _ s) = s

literal :: QuasiQuoter
literal = QuasiQuoter (quoteJavaExp "tok_Literal_dummy_144" getLiteral ) (quoteJavaPat "tok_Literal_dummy_144" getLiteral ) quoteJavaType quoteJavaDecs

getMemberAfterFirstId ( Ctr__Java__35 _ s) = s

memberAfterFirstId :: QuasiQuoter
memberAfterFirstId = QuasiQuoter (quoteJavaExp "tok_MemberAfterFirstId_dummy_143" getMemberAfterFirstId ) (quoteJavaPat "tok_MemberAfterFirstId_dummy_143" getMemberAfterFirstId ) quoteJavaType quoteJavaDecs

getMemberDeclaration ( Ctr__Java__36 _ s) = s

memberDeclaration :: QuasiQuoter
memberDeclaration = QuasiQuoter (quoteJavaExp "tok_MemberDeclaration_dummy_142" getMemberDeclaration ) (quoteJavaPat "tok_MemberDeclaration_dummy_142" getMemberDeclaration ) quoteJavaType quoteJavaDecs

getMemberRest ( Ctr__Java__37 _ s) = s

memberRest :: QuasiQuoter
memberRest = QuasiQuoter (quoteJavaExp "tok_MemberRest_dummy_141" getMemberRest ) (quoteJavaPat "tok_MemberRest_dummy_141" getMemberRest ) quoteJavaType quoteJavaDecs

getModifier ( Ctr__Java__38 _ s) = s

modifier :: QuasiQuoter
modifier = QuasiQuoter (quoteJavaExp "tok_Modifier_dummy_140" getModifier ) (quoteJavaPat "tok_Modifier_dummy_140" getModifier ) quoteJavaType quoteJavaDecs

getModifierList ( Ctr__Java__39 _ s) = s

modifierList :: QuasiQuoter
modifierList = QuasiQuoter (quoteJavaExp "tok_ModifierList_dummy_139" getModifierList ) (quoteJavaPat "tok_ModifierList_dummy_139" getModifierList ) quoteJavaType quoteJavaDecs

getMoreTypeSpecifier ( Ctr__Java__40 _ s) = s

moreTypeSpecifier :: QuasiQuoter
moreTypeSpecifier = QuasiQuoter (quoteJavaExp "tok_MoreTypeSpecifier_dummy_138" getMoreTypeSpecifier ) (quoteJavaPat "tok_MoreTypeSpecifier_dummy_138" getMoreTypeSpecifier ) quoteJavaType quoteJavaDecs

getMoreVariableDeclarators ( Ctr__Java__41 _ s) = s

moreVariableDeclarators :: QuasiQuoter
moreVariableDeclarators = QuasiQuoter (quoteJavaExp "tok_MoreVariableDeclarators_dummy_137" getMoreVariableDeclarators ) (quoteJavaPat "tok_MoreVariableDeclarators_dummy_137" getMoreVariableDeclarators ) quoteJavaType quoteJavaDecs

getMultiplicativeOp ( Ctr__Java__42 _ s) = s

multiplicativeOp :: QuasiQuoter
multiplicativeOp = QuasiQuoter (quoteJavaExp "tok_MultiplicativeOp_dummy_136" getMultiplicativeOp ) (quoteJavaPat "tok_MultiplicativeOp_dummy_136" getMultiplicativeOp ) quoteJavaType quoteJavaDecs

getNestedTypeDeclaration ( Ctr__Java__43 _ s) = s

nestedTypeDeclaration :: QuasiQuoter
nestedTypeDeclaration = QuasiQuoter (quoteJavaExp "tok_NestedTypeDeclaration_dummy_135" getNestedTypeDeclaration ) (quoteJavaPat "tok_NestedTypeDeclaration_dummy_135" getNestedTypeDeclaration ) quoteJavaType quoteJavaDecs

getNonEmptyDims ( Ctr__Java__44 _ s) = s

nonEmptyDims :: QuasiQuoter
nonEmptyDims = QuasiQuoter (quoteJavaExp "tok_NonEmptyDims_dummy_134" getNonEmptyDims ) (quoteJavaPat "tok_NonEmptyDims_dummy_134" getNonEmptyDims ) quoteJavaType quoteJavaDecs

getNonEmptyTypeArguments ( Ctr__Java__45 _ s) = s

nonEmptyTypeArguments :: QuasiQuoter
nonEmptyTypeArguments = QuasiQuoter (quoteJavaExp "tok_NonEmptyTypeArguments_dummy_133" getNonEmptyTypeArguments ) (quoteJavaPat "tok_NonEmptyTypeArguments_dummy_133" getNonEmptyTypeArguments ) quoteJavaType quoteJavaDecs

getOptDocComment ( Ctr__Java__46 _ s) = s

optDocComment :: QuasiQuoter
optDocComment = QuasiQuoter (quoteJavaExp "tok_OptDocComment_dummy_132" getOptDocComment ) (quoteJavaPat "tok_OptDocComment_dummy_132" getOptDocComment ) quoteJavaType quoteJavaDecs

getOptElsePart ( Ctr__Java__47 _ s) = s

optElsePart :: QuasiQuoter
optElsePart = QuasiQuoter (quoteJavaExp "tok_OptElsePart_dummy_131" getOptElsePart ) (quoteJavaPat "tok_OptElsePart_dummy_131" getOptElsePart ) quoteJavaType quoteJavaDecs

getOptExpression ( Ctr__Java__48 _ s) = s

optExpression :: QuasiQuoter
optExpression = QuasiQuoter (quoteJavaExp "tok_OptExpression_dummy_130" getOptExpression ) (quoteJavaPat "tok_OptExpression_dummy_130" getOptExpression ) quoteJavaType quoteJavaDecs

getOptFinally ( Ctr__Java__49 _ s) = s

optFinally :: QuasiQuoter
optFinally = QuasiQuoter (quoteJavaExp "tok_OptFinally_dummy_129" getOptFinally ) (quoteJavaPat "tok_OptFinally_dummy_129" getOptFinally ) quoteJavaType quoteJavaDecs

getOptId ( Ctr__Java__50 _ s) = s

optId :: QuasiQuoter
optId = QuasiQuoter (quoteJavaExp "tok_OptId_dummy_128" getOptId ) (quoteJavaPat "tok_OptId_dummy_128" getOptId ) quoteJavaType quoteJavaDecs

getOptVariableInitializer ( Ctr__Java__51 _ s) = s

optVariableInitializer :: QuasiQuoter
optVariableInitializer = QuasiQuoter (quoteJavaExp "tok_OptVariableInitializer_dummy_127" getOptVariableInitializer ) (quoteJavaPat "tok_OptVariableInitializer_dummy_127" getOptVariableInitializer ) quoteJavaType quoteJavaDecs

getPackage ( Ctr__Java__52 _ s) = s

package :: QuasiQuoter
package = QuasiQuoter (quoteJavaExp "tok_Package_dummy_126" getPackage ) (quoteJavaPat "tok_Package_dummy_126" getPackage ) quoteJavaType quoteJavaDecs

getParameter ( Ctr__Java__53 _ s) = s

parameter :: QuasiQuoter
parameter = QuasiQuoter (quoteJavaExp "tok_Parameter_dummy_125" getParameter ) (quoteJavaPat "tok_Parameter_dummy_125" getParameter ) quoteJavaType quoteJavaDecs

getParameterList ( Ctr__Java__54 _ s) = s

parameterList :: QuasiQuoter
parameterList = QuasiQuoter (quoteJavaExp "tok_ParameterList_dummy_124" getParameterList ) (quoteJavaPat "tok_ParameterList_dummy_124" getParameterList ) quoteJavaType quoteJavaDecs

getPostfixOp ( Ctr__Java__55 _ s) = s

postfixOp :: QuasiQuoter
postfixOp = QuasiQuoter (quoteJavaExp "tok_PostfixOp_dummy_123" getPostfixOp ) (quoteJavaPat "tok_PostfixOp_dummy_123" getPostfixOp ) quoteJavaType quoteJavaDecs

getPrefixOp ( Ctr__Java__56 _ s) = s

prefixOp :: QuasiQuoter
prefixOp = QuasiQuoter (quoteJavaExp "tok_PrefixOp_dummy_122" getPrefixOp ) (quoteJavaPat "tok_PrefixOp_dummy_122" getPrefixOp ) quoteJavaType quoteJavaDecs

getPrimitiveTypeKeyword ( Ctr__Java__57 _ s) = s

primitiveTypeKeyword :: QuasiQuoter
primitiveTypeKeyword = QuasiQuoter (quoteJavaExp "tok_PrimitiveTypeKeyword_dummy_121" getPrimitiveTypeKeyword ) (quoteJavaPat "tok_PrimitiveTypeKeyword_dummy_121" getPrimitiveTypeKeyword ) quoteJavaType quoteJavaDecs

getRelationalOp ( Ctr__Java__58 _ s) = s

relationalOp :: QuasiQuoter
relationalOp = QuasiQuoter (quoteJavaExp "tok_RelationalOp_dummy_120" getRelationalOp ) (quoteJavaPat "tok_RelationalOp_dummy_120" getRelationalOp ) quoteJavaType quoteJavaDecs

getShiftOp ( Ctr__Java__59 _ s) = s

shiftOp :: QuasiQuoter
shiftOp = QuasiQuoter (quoteJavaExp "tok_ShiftOp_dummy_119" getShiftOp ) (quoteJavaPat "tok_ShiftOp_dummy_119" getShiftOp ) quoteJavaType quoteJavaDecs

getStatement ( Ctr__Java__60 _ s) = s

statement :: QuasiQuoter
statement = QuasiQuoter (quoteJavaExp "tok_Statement_dummy_118" getStatement ) (quoteJavaPat "tok_Statement_dummy_118" getStatement ) quoteJavaType quoteJavaDecs

getStatementBlock ( Ctr__Java__61 _ s) = s

statementBlock :: QuasiQuoter
statementBlock = QuasiQuoter (quoteJavaExp "tok_StatementBlock_dummy_117" getStatementBlock ) (quoteJavaPat "tok_StatementBlock_dummy_117" getStatementBlock ) quoteJavaType quoteJavaDecs

getStatementList ( Ctr__Java__62 _ s) = s

statementList :: QuasiQuoter
statementList = QuasiQuoter (quoteJavaExp "tok_StatementList_dummy_116" getStatementList ) (quoteJavaPat "tok_StatementList_dummy_116" getStatementList ) quoteJavaType quoteJavaDecs

getStatementWithoutIf ( Ctr__Java__63 _ s) = s

statementWithoutIf :: QuasiQuoter
statementWithoutIf = QuasiQuoter (quoteJavaExp "tok_StatementWithoutIf_dummy_115" getStatementWithoutIf ) (quoteJavaPat "tok_StatementWithoutIf_dummy_115" getStatementWithoutIf ) quoteJavaType quoteJavaDecs

getStaticInitializer ( Ctr__Java__64 _ s) = s

staticInitializer :: QuasiQuoter
staticInitializer = QuasiQuoter (quoteJavaExp "tok_StaticInitializer_dummy_114" getStaticInitializer ) (quoteJavaPat "tok_StaticInitializer_dummy_114" getStaticInitializer ) quoteJavaType quoteJavaDecs

getSwitchCaseList ( Ctr__Java__65 _ s) = s

switchCaseList :: QuasiQuoter
switchCaseList = QuasiQuoter (quoteJavaExp "tok_SwitchCaseList_dummy_113" getSwitchCaseList ) (quoteJavaPat "tok_SwitchCaseList_dummy_113" getSwitchCaseList ) quoteJavaType quoteJavaDecs

getSwitchStatement ( Ctr__Java__66 _ s) = s

switchStatement :: QuasiQuoter
switchStatement = QuasiQuoter (quoteJavaExp "tok_SwitchStatement_dummy_112" getSwitchStatement ) (quoteJavaPat "tok_SwitchStatement_dummy_112" getSwitchStatement ) quoteJavaType quoteJavaDecs

getTryStatement ( Ctr__Java__67 _ s) = s

tryStatement :: QuasiQuoter
tryStatement = QuasiQuoter (quoteJavaExp "tok_TryStatement_dummy_111" getTryStatement ) (quoteJavaPat "tok_TryStatement_dummy_111" getTryStatement ) quoteJavaType quoteJavaDecs

getType ( Ctr__Java__68 _ s) = s

__type :: QuasiQuoter
__type = QuasiQuoter (quoteJavaExp "tok_Type_dummy_110" getType ) (quoteJavaPat "tok_Type_dummy_110" getType ) quoteJavaType quoteJavaDecs

getTypeArgument ( Ctr__Java__69 _ s) = s

typeArgument :: QuasiQuoter
typeArgument = QuasiQuoter (quoteJavaExp "tok_TypeArgument_dummy_109" getTypeArgument ) (quoteJavaPat "tok_TypeArgument_dummy_109" getTypeArgument ) quoteJavaType quoteJavaDecs

getTypeArguments ( Ctr__Java__70 _ s) = s

typeArguments :: QuasiQuoter
typeArguments = QuasiQuoter (quoteJavaExp "tok_TypeArguments_dummy_108" getTypeArguments ) (quoteJavaPat "tok_TypeArguments_dummy_108" getTypeArguments ) quoteJavaType quoteJavaDecs

getTypeDeclaration ( Ctr__Java__71 _ s) = s

typeDeclaration :: QuasiQuoter
typeDeclaration = QuasiQuoter (quoteJavaExp "tok_TypeDeclaration_dummy_107" getTypeDeclaration ) (quoteJavaPat "tok_TypeDeclaration_dummy_107" getTypeDeclaration ) quoteJavaType quoteJavaDecs

getTypeParameter ( Ctr__Java__72 _ s) = s

typeParameter :: QuasiQuoter
typeParameter = QuasiQuoter (quoteJavaExp "tok_TypeParameter_dummy_106" getTypeParameter ) (quoteJavaPat "tok_TypeParameter_dummy_106" getTypeParameter ) quoteJavaType quoteJavaDecs

getTypeParameters ( Ctr__Java__73 _ s) = s

typeParameters :: QuasiQuoter
typeParameters = QuasiQuoter (quoteJavaExp "tok_TypeParameters_dummy_105" getTypeParameters ) (quoteJavaPat "tok_TypeParameters_dummy_105" getTypeParameters ) quoteJavaType quoteJavaDecs

getTypeSpecifier ( Ctr__Java__74 _ s) = s

typeSpecifier :: QuasiQuoter
typeSpecifier = QuasiQuoter (quoteJavaExp "tok_TypeSpecifier_dummy_104" getTypeSpecifier ) (quoteJavaPat "tok_TypeSpecifier_dummy_104" getTypeSpecifier ) quoteJavaType quoteJavaDecs

getVariableDeclaration ( Ctr__Java__75 _ s) = s

variableDeclaration :: QuasiQuoter
variableDeclaration = QuasiQuoter (quoteJavaExp "tok_VariableDeclaration_dummy_103" getVariableDeclaration ) (quoteJavaPat "tok_VariableDeclaration_dummy_103" getVariableDeclaration ) quoteJavaType quoteJavaDecs

getVariableDeclarator ( Ctr__Java__76 _ s) = s

variableDeclarator :: QuasiQuoter
variableDeclarator = QuasiQuoter (quoteJavaExp "tok_VariableDeclarator_dummy_102" getVariableDeclarator ) (quoteJavaPat "tok_VariableDeclarator_dummy_102" getVariableDeclarator ) quoteJavaType quoteJavaDecs

getVariableDeclaratorList ( Ctr__Java__77 _ s) = s

variableDeclaratorList :: QuasiQuoter
variableDeclaratorList = QuasiQuoter (quoteJavaExp "tok_VariableDeclaratorList_dummy_101" getVariableDeclaratorList ) (quoteJavaPat "tok_VariableDeclaratorList_dummy_101" getVariableDeclaratorList ) quoteJavaType quoteJavaDecs

getVariableInitializer ( Ctr__Java__78 _ s) = s

variableInitializer :: QuasiQuoter
variableInitializer = QuasiQuoter (quoteJavaExp "tok_VariableInitializer_dummy_100" getVariableInitializer ) (quoteJavaPat "tok_VariableInitializer_dummy_100" getVariableInitializer ) quoteJavaType quoteJavaDecs

getVariableInitializerList ( Ctr__Java__79 _ s) = s

variableInitializerList :: QuasiQuoter
variableInitializerList = QuasiQuoter (quoteJavaExp "tok_VariableInitializerList_dummy_99" getVariableInitializerList ) (quoteJavaPat "tok_VariableInitializerList_dummy_99" getVariableInitializerList ) quoteJavaType quoteJavaDecs

getWhileStatement ( Ctr__Java__80 _ s) = s

whileStatement :: QuasiQuoter
whileStatement = QuasiQuoter (quoteJavaExp "tok_WhileStatement_dummy_98" getWhileStatement ) (quoteJavaPat "tok_WhileStatement_dummy_98" getWhileStatement ) quoteJavaType quoteJavaDecs

getWildcardType ( Ctr__Java__81 _ s) = s

wildcardType :: QuasiQuoter
wildcardType = QuasiQuoter (quoteJavaExp "tok_WildcardType_dummy_97" getWildcardType ) (quoteJavaPat "tok_WildcardType_dummy_97" getWildcardType ) quoteJavaType quoteJavaDecs
