...
Note: the `--use-generated` flag does not exist yet. A stub version that
only printed an error was removed from the CLI; the flag will be added
back when this prototype is actually implemented.
